...
//        float yaw = dataTracker.get(HEAD_YAW);
    ...
    protected PlayState controller(final AnimationState<GeoAnimatable> event)
    {
...
//        event.getController().setAnimation(WormActions.getAnimation(dataTracker.get(CURRENT_ACTION)));
    ...
    {
        controllers.add(new AnimationController<GeoAnimatable>(this, "controller", 5, this::controller));
    }
