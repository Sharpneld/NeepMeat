...
public class NMItems
{
    ...
    public static Item SACRIFICIAL_SCALPEL = new DaggerItem("sacrificial_dagger", new FabricItemSettings().group(MeatWeapons.WEAPONS));
...
//    public static Item INTERFACE_PORTS = new BaseCraftingItem("interface_array", 1, new FabricItemSettings().group(NMItemGroups.INGREDIENTS));
    ...
    public static Item CONTRACTILE_ACTUATOR = new BaseCraftingItem("contractile_actuator", 0, new FabricItemSettings().group(NMItemGroups.INGREDIENTS));
...
//    public static Item MEAT_STEEL_CHESTPLATE = new MeatSteelArmourItem("meat_steel_chestplate", ArmorMaterials.DIAMOND, EquipmentSlot.CHEST, new FabricItemSettings().group(NMItemGroups.GENERAL));
    ...
    public static Item DOSIMETER = new DosimeterItem("dosimeter", TooltipSupplier.hidden(1), new FabricItemSettings().group(NMItemGroups.GENERAL));
